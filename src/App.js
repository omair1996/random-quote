...
function App() {
  ...
  return (
    ...
    <div className="App">
     ...
     <a id="tweet-quote" href={"https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=" } target="_blank"><button>Tweet it</button></a></div><div className='text-center'>
